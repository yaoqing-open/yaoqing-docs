  ...
  return [
    ...
    },
    {
      ...
      items: [
		...
		{ text: 'MySQL 接入说明', link: '4数据接入/MySQL 接入' },
		{ text: 'TiDB Cloud 接入说明', link: '4数据接入/TiDB Cloud 接入' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: '爻擎 SQL 规范', link: '5数据清洗/爻擎 SQL 规范' },
        { text: '爻擎 SQL 函数', link: '5数据清洗/爻擎 SQL 函数' },
