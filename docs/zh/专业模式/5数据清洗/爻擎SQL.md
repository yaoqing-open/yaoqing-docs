...
| `LAST_2_MINUTE_STRING()`						| 动态值，前1分钟0秒的`yyyy-MM-dd HH:mm:00`的字符串																| `select LAST_2_MINUTE()`														| `2025-06-06 14:35:00`		|
| `LAST_3_HOUR_STRING()`						| 动态值，前2小时0分0秒的`yyyy-MM-dd HH:00:00`的字符串																		| `select LAST_3_HOUR()`														| `2025-06-06 12:00:00`		|
| `LAST_2_DAY_STRING()`						| 动态值，前1天的0时0分0秒的`yyyy-MM-dd 00:00:00`的字符串																			| `select LAST_2_DAY()`															| `2025-06-05 00:00:00`		|
